        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="pages/produk.php?&halaman=1" class="active"><i class="fa fa-leaf" aria-hidden="true"></i>  Produk</a>
                    </li>
                    <li>
                        <a href="pages/konfirmasi.php" class="active"><i class="fa fa-check-square-o" aria-hidden="true"></i>  Konfirmasi Pembayaran</a>
                    </li>
                    <li>
                        <a href="pages/kategori.php?&halaman=1" class="active"><i class="fa fa-bars" aria-hidden="true"></i>  Kategori Produk</a>
                    </li>
                     <li>
                        <a href="pages/metode_pembayaran.php" class="active"><i class="fa fa-life-ring" aria-hidden="true"></i>  Metode Pembayaran</a>
                    </li>
                </ul>
